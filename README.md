...
*   **`/docs`**: Operational process tooling — volatile, workflow-driven assets:
    ...
    *   `logs/`: Development history records, including the [`agent-changelog.md`](docs/logs/agent-changelog.md).

---

## How to Use This Template

1.  **Configure the Vision**: Edit [`docs/wiki/core/01-vision-north-star.md`](docs/wiki/core/01-vision-north-star.md) to define the application's core goals.
2.  **Define the Structure**: Build out the schemas, routes, and features in the `/docs/wiki` directory to establish a clear architectural layout before writing code.
