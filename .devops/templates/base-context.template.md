...
YAML frontmatter of every .devops/agents/parcel.agent.md, .devops/agents/parcel-fast.agent.md,
...
(parcel.agent.md, parcel-fast.agent.md, parcel-sprint.agent.md). Editing it requires re-running
