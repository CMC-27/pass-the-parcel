...
| Slot | Doc | Theme | Verification Set |
| :--- | :--- | :--- | :--- |
| 00 | System Index (The Hub) | Hub | `references/verify-00-system-index.md` |
| 01 | Vision & North Star | Strategy | `references/verify-01-vision-north-star.md` |
| 02 | Product Context | Strategy | `references/verify-02-product-context.md` |
| 03 | Glossary of Terms | Strategy | `references/verify-03-glossary-of-terms.md` |
| 04 | State & Context | Architecture | `references/verify-04-state-context.md` |
| 05 | Core Architecture | Architecture | `references/verify-05-core-architecture.md` |
| 06 | Directory Structure | Architecture | `references/verify-06-directory-structure.md` |
| 07 | App Structure | Architecture | `references/verify-07-app-structure.md` |
| 08 | User Journey | Workflow | `references/verify-08-user-journey.md` |
| 09 | Design System | Design | `references/verify-09-design-system.md` |
| 10 | Validation Standards | Standards | `references/verify-10-validation-standards.md` |
| 11 | Utility Standards | Standards | `references/verify-11-utility-standards.md` |
| 12 | Security Standards | Standards | `references/verify-12-security-standards.md` |
| 13 | Performance Standards | Standards | `references/verify-13-performance-standards.md` |
| 14 | *(Testing Standards handled by testing/* subtree)* | — | — |
| 15 | AI Features | Features | `references/verify-15-ai-features.md` |
| 16 | External Integrations | Features | `references/verify-16-external-integrations.md` |
| 17 | Docs Blueprint | Meta | `references/verify-17-docs-blueprint.md` |
| 18 | Knowledge Capture | Meta | `references/verify-18-knowledge-capture.md` |
