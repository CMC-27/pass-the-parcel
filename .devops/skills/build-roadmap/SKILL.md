...
|---|---|---|---|
| **L2** | `product-roadmap.md` | Phases (Phase 1, 2, 3…) | `.devops/backlog/` |
| **L3** | `<feature>-backlog.md` | Backlog items per phase | `.devops/backlog/` |
...
Before doing anything else, scan for an existing `product-roadmap.md` in the project's `.devops/backlog/` directory. If one exists, read it in full to understand current phase definitions, scope, and version number.
...
1. Create a `<feature-slug>-backlog.md` (suffixed with `-backlog`) in `.devops/backlog/` using the Pass-the-Parcel backlog template.
...
4. Add a bullet entry to `.devops/backlog/backlog-index.md` linking to the new file.
