...
4. Read `docs/logs/agent-changelog.md` (last 10 entries) for recent shipped work.
...
>
> **Proposed Changelog Row** (for `docs/logs/knowledge-changelog.md`)
...
- [ ] `docs/logs/agent-changelog.md` updated (per project wrap-up protocol).
