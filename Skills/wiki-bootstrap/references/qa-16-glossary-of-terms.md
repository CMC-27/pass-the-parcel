...
2. For each design token name (referenced from `05-design-system.md`), what is its semantic meaning in this app?
...
- `docs/wiki/core/05-design-system.md` — design token semantics
