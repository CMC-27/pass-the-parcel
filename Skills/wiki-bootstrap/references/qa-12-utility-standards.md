...
- Visual styling micro-patterns (e.g., metallic edges, tinted shadows, glassmorphism configs) — reference `05-design-system.md` for tokens, keep logic here
...
- `docs/wiki/core/05-design-system.md` — referenced for tokens (do not duplicate)
