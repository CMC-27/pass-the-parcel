...
- Visual styling micro-patterns (referenced, not duplicated from `05-design-system.md`)
...
6. Does the doc correctly reference `05-design-system.md` instead of duplicating token names?
