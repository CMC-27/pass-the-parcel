...
This directory contains completed and closed implementation plans. Plans are moved here from `docs/plans/` when the task is complete via the `@agent-wrap-up` skill.
